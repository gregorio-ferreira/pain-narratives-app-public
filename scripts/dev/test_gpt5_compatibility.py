...
def test_basic_gpt5_functionality():
    ...
    try:
        ...
        response = client.create_completion(
            messages=messages, model="gpt-5", temperature=1.0, max_tokens=100  # Use default temperature for GPT-5
        )
...
def test_gpt5_mini_functionality():
    ...
    try:
        ...
        response = client.create_completion(messages=messages, model="gpt-5-mini", temperature=1.0, max_tokens=50)
